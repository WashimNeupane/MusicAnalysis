    ...
    public class timefreq
    {
        ...
        Complex[] fft(Complex[] x)
        {
            ...
            if (N == 1)
            {
                ...
                //METHOD-1
                //Task Task1 = new Task(() => { E = fft(even); });
                //Task Task2 = new Task(() => { O = fft(odd); });                
                //for (kk = 0; kk < N; kk++)
                //{
                ...
                //METHOD-2. 
                //NOTE: WE CAN SIMPLY DO THE SAME THING WITH MAINWindow:fft() as well. 
                E = fft(even);
                O = fft(odd);
                ...
                //modification of for loop taking into account the symmetrical properties
                //Parallel.For(0, N / 2, kk =>
                // {
                //     Y[kk] = E[(kk % (N / 2))] + O[(kk % (N / 2))] * twiddles[kk * wSamp / N];
                // });
                ...
                //Parallel.For (0, N / 2, kk =>
                // {
                //     Y[kk+ (N/2)] = E[(kk % (N / 2))] + O[(kk % (N / 2))] * twiddles[kk * wSamp / N];
                // }) ;
            }
           return Y;
        }        
